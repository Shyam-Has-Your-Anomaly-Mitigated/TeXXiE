...
\subsection{Dailies}
\item \texttt{Touch Typing\phantom{ng}:} \textit{67} WPM @ \textit{99}\% accuracy, over \href{https://www.typing.com/student/test/5}{5 minutes}.%(My computer is lagging; I usually get 10 more WPMs, but I had to stop, and wait for my computer to catch up to see if there were any bugs...)
\item \texttt{$\text{\texttt{2}}^\text{\texttt{3}}$ Speedcubing:} \textit{00}:\textit{19}.\textit{79} via \href{http://www.cubetimer.com/}{this link}.
\item \texttt{$\text{\texttt{3}}^\text{\texttt{3}}$ Speedcubing:} \textit{01}:\textit{26}.\textit{27} via \href{http://www.cubetimer.com/}{this link}.
\item \texttt{$\text{\texttt{3}}^\text{\texttt{3}}$ Blindfolded:} \textit{06}:\textit{03}.\textit{73} via \href{http://www.cubetimer.com/}{this link}.
...
%\includepdf[pages=-]{ref/Soldier.pdf}
