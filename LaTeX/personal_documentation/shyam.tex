...
\begin{description}
    ...
    \begin{description}
        ...
        \item \texttt{\phantom{**}\href{https://www.open.edu.au/subjects/rmit-university-building-it-systems-rmi-cpt111}{CPT111}:} \uniU{Building IT Systems}
        ...
        \item \texttt{\phantom{**}\href{https://www.open.edu.au/subjects/rmit-university-professional-computing-practice-rmi-cpt310}{CPT310}:} \uniF{Professional Computing Practice}
    ...
    \begin{description}
        ...
        \item \texttt{\phantom{**}\href{https://www.open.edu.au/subjects/university-of-south-australia-engineering-modelling-usa-enr208}{ENR208}:} \uniU{Engineering Modelling}
    \end{description}
    ...
    \begin{description}
        ...
        \item \texttt{\phantom{**}\href{https://www.open.edu.au/subjects/rmit-university-discrete-maths-rmi-mat17}{MAT17\phantom{*}}:} \uniU{Discrete Maths}
...
\subsection{Dailies}
\item \texttt{Touch Typing\phantom{ng}:} \textit{72} WPM @ \textit{99}\% accuracy, over \href{https://www.typing.com/student/test/5}{5 minutes}.%(My computer is lagging; I usually get 10 more WPMs, but I had to stop, and wait for my computer to catch up to see if there were any bugs...)
\item \texttt{$\text{\texttt{2}}^\text{\texttt{3}}$ Speedcubing:} \textit{00}:\textit{21}.\textit{07} via \href{http://www.cubetimer.com/}{this link}.
\item \texttt{$\text{\texttt{3}}^\text{\texttt{3}}$ Speedcubing:} \textit{02}:\textit{14}.\textit{13} via \href{http://www.cubetimer.com/}{this link}.
\item \texttt{$\text{\texttt{3}}^\text{\texttt{3}}$ Blindfolded:} \textit{04}:\textit{32}.\textit{25} via \href{http://www.cubetimer.com/}{this link}.
...
\xp{Volunteer}{Sydney}{NSW}{AU}{2017\textapprox{}2018}
